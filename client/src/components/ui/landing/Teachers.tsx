import { profesores } from "../../../utils/mocks/teachers.mock";

const Teachers = () => {
  return (
    <section id="teachers" className="w-full bg-gradient-to-br from-blue-50 via-white to-blue-50 py-20 px-5 animate-fade-in-up">
