...
import { UploadProfilePicture } from '../../../api/middlewares/SubImage.mjs';
...
router.post('/create-profile', UploadProfilePicture, controllerInstructor.createInstructorProfile);
// Ruta para que un instructor actualice su perfil
router.patch('/update-profile/:instructorId', UploadProfilePicture, controllerInstructor.updateInstructorProfile);
